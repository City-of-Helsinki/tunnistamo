...
env = environ.Env(
    ...
    ALWAYS_REAUTHENTICATE_BACKENDS=(list, []),
    ...
    SOCIAL_AUTH_GOOGLE_USE_UNIQUE_USER_ID=(bool, False),
    ...
    SOCIAL_AUTH_ESPOO_KEY=(str, ""),
    SOCIAL_AUTH_ESPOO_SECRET=(str, ""),
    ...
    SOCIAL_AUTH_VANTAAAZUREAD_TENANT_ID=(str, ""),
    SOCIAL_AUTH_VANTAAAZUREAD_RESOURCE=(str, ""),
    SOCIAL_AUTH_VANTAAAZUREAD_KEY=(str, ""),
    SOCIAL_AUTH_VANTAAAZUREAD_SECRET=(str, ""),

    SOCIAL_AUTH_ESPOOAZUREAD_TENANT_ID=(str, ""),
    SOCIAL_AUTH_ESPOOAZUREAD_RESOURCE=(str, ""),
    SOCIAL_AUTH_ESPOOAZUREAD_KEY=(str, ""),
    SOCIAL_AUTH_ESPOOAZUREAD_SECRET=(str, ""),

    SOCIAL_AUTH_VAKEHYVAAZUREAD_TENANT_ID=(str, ""),
    SOCIAL_AUTH_VAKEHYVAAZUREAD_RESOURCE=(str, ""),
    SOCIAL_AUTH_VAKEHYVAAZUREAD_KEY=(str, ""),
    SOCIAL_AUTH_VAKEHYVAAZUREAD_SECRET=(str, ""),
)
...
AUTHENTICATION_BACKENDS = (
    ...
    'auth_backends.vantaa_azure_ad.VantaaAzureADV2TenantOAuth2',
    'auth_backends.espoo_azure_ad.EspooAzureADV2TenantOAuth2',
    'auth_backends.vakehyva_azure_ad.VakehyvaAzureADV2TenantOAuth2',
)
...
ALWAYS_REAUTHENTICATE_BACKENDS = env("ALWAYS_REAUTHENTICATE_BACKENDS")
...
SOCIAL_AUTH_FIELDS_STORED_IN_SESSION = ['idp_hint']
...
SOCIAL_AUTH_GOOGLE_USE_UNIQUE_USER_ID = env("SOCIAL_AUTH_GOOGLE_USE_UNIQUE_USER_ID")
...
SOCIAL_AUTH_ESPOO_KEY = env("SOCIAL_AUTH_ESPOO_KEY")
SOCIAL_AUTH_ESPOO_SECRET = env("SOCIAL_AUTH_ESPOO_SECRET")
...
SOCIAL_AUTH_VANTAAAZUREAD_TENANT_ID = env("SOCIAL_AUTH_VANTAAAZUREAD_TENANT_ID")
SOCIAL_AUTH_VANTAAAZUREAD_RESOURCE = env("SOCIAL_AUTH_VANTAAAZUREAD_RESOURCE")
SOCIAL_AUTH_VANTAAAZUREAD_KEY = env("SOCIAL_AUTH_VANTAAAZUREAD_KEY")
SOCIAL_AUTH_VANTAAAZUREAD_SECRET = env("SOCIAL_AUTH_VANTAAAZUREAD_SECRET")

SOCIAL_AUTH_ESPOOAZUREAD_TENANT_ID = env("SOCIAL_AUTH_ESPOOAZUREAD_TENANT_ID")
SOCIAL_AUTH_ESPOOAZUREAD_RESOURCE = env("SOCIAL_AUTH_ESPOOAZUREAD_RESOURCE")
SOCIAL_AUTH_ESPOOAZUREAD_KEY = env("SOCIAL_AUTH_ESPOOAZUREAD_KEY")
SOCIAL_AUTH_ESPOOAZUREAD_SECRET = env("SOCIAL_AUTH_ESPOOAZUREAD_SECRET")

SOCIAL_AUTH_VAKEHYVAAZUREAD_TENANT_ID = env("SOCIAL_AUTH_VAKEHYVAAZUREAD_TENANT_ID")
SOCIAL_AUTH_VAKEHYVAAZUREAD_RESOURCE = env("SOCIAL_AUTH_VAKEHYVAAZUREAD_RESOURCE")
SOCIAL_AUTH_VAKEHYVAAZUREAD_KEY = env("SOCIAL_AUTH_VAKEHYVAAZUREAD_KEY")
SOCIAL_AUTH_VAKEHYVAAZUREAD_SECRET = env("SOCIAL_AUTH_VAKEHYVAAZUREAD_SECRET")
