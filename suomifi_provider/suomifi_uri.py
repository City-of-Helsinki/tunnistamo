...
FI_OID = "urn:oid:1.2.246."
VARMENNEPALVELUT_OID = FI_OID + "517."

MAP = {
    "identifier": "urn:oasis:names:tc:SAML:2.0:attrname-format:uri",
    "fro": {
        FI_OID + '22': 'electronicIdentificationNumber',
        FI_OID + '21': 'nationalIdentificationNumber',
        VARMENNEPALVELUT_OID + '3003.113.4': 'kid',
        X500ATTR_OID + '3': 'cn',
        'http://eidas.europa.eu/attributes/naturalperson/CurrentGivenName': 'FirstName',
        VARMENNEPALVELUT_OID + '2002.2.18': 'KotikuntaKuntanumero',
        VARMENNEPALVELUT_OID + '2002.2.19': 'KotikuntaKuntaS',
        VARMENNEPALVELUT_OID + '2002.2.20': 'KotikuntaKuntaR',
        VARMENNEPALVELUT_OID + '2002.2.4': 'VakinainenKotimainenLahiosoiteS',
        VARMENNEPALVELUT_OID + '2002.2.5': 'VakinainenKotimainenLahiosoiteR',
        VARMENNEPALVELUT_OID + '2002.2.6': 'VakinainenKotimainenLahiosoitePostinumero',
        VARMENNEPALVELUT_OID + '2002.2.7': 'VakinainenKotimainenLahiosoitePostitoimipaikkaS',
        VARMENNEPALVELUT_OID + '2002.2.8': 'VakinainenKotimainenLahiosoitePostitoimipaikkaR',
        VARMENNEPALVELUT_OID + '2002.2.11': 'VakinainenUlkomainenLahiosoite',
        VARMENNEPALVELUT_OID + '2002.2.12': 'VakinainenUlkomainenLahiosoitePaikkakuntaJaValtioS',
        VARMENNEPALVELUT_OID + '2002.2.13': 'VakinainenUlkomainenLahiosoitePaikkakuntaJaValtioR',
        VARMENNEPALVELUT_OID + '2002.2.14': 'VakinainenUlkomainenLahiosoitePaikkakuntaJaValtioSelvakielinen',
        VARMENNEPALVELUT_OID + '2002.2.15': 'VakinainenUlkomainenLahiosoiteValtiokoodi',
    ...
    "to": {
        'electronicIdentificationNumber': FI_OID + '22',
        'nationalIdentificationNumber': FI_OID + '21',
        'kid': VARMENNEPALVELUT_OID + '3003.113.4',
        'cn': X500ATTR_OID + '3',
        'FirstName': 'http://eidas.europa.eu/attributes/naturalperson/CurrentGivenName',
        'KotikuntaKuntanumero': VARMENNEPALVELUT_OID + '2002.2.18',
        'KotikuntaKuntaS': VARMENNEPALVELUT_OID + '2002.2.19',
        'KotikuntaKuntaR': VARMENNEPALVELUT_OID + '2002.2.20',
        'VakinainenKotimainenLahiosoiteS': VARMENNEPALVELUT_OID + '2002.2.4',
        'VakinainenKotimainenLahiosoiteR': VARMENNEPALVELUT_OID + '2002.2.5',
        'VakinainenKotimainenLahiosoitePostinumero': VARMENNEPALVELUT_OID + '2002.2.6',
        'VakinainenKotimainenLahiosoitePostitoimipaikkaS': VARMENNEPALVELUT_OID + '2002.2.7',
        'VakinainenKotimainenLahiosoitePostitoimipaikkaR': VARMENNEPALVELUT_OID + '2002.2.8',
        'VakinainenUlkomainenLahiosoite': VARMENNEPALVELUT_OID + '2002.2.11',
        'VakinainenUlkomainenLahiosoitePaikkakuntaJaValtioS': VARMENNEPALVELUT_OID + '2002.2.12',
        'VakinainenUlkomainenLahiosoitePaikkakuntaJaValtioR': VARMENNEPALVELUT_OID + '2002.2.13',
        'VakinainenUlkomainenLahiosoitePaikkakuntaJaValtioSelvakielinen': VARMENNEPALVELUT_OID + '2002.2.14',
