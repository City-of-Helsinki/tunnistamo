# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-06-27 05:46
                ...
                ('name', models.CharField(
                    max_length=50, validators=[
                        django.core.validators.RegexValidator(
                            '^[a-z0-9]*$', message=(
                                'May contain only lower case letters '
                                'and digits.'))],
                    verbose_name='name')),
                ('required_scopes',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api', models.ForeignKey(
                    help_text='The API that this scope is for.',
                    on_delete=django.db.models.deletion.CASCADE,
                    related_name='scopes',
                    to='oidc_apis.Api', verbose_name='API')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(
                    ...
                    related_name='translations', to='oidc_apis.ApiScope',
                    verbose_name='API scope')),
            ],
            options={
